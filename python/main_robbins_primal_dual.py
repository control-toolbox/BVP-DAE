...
from Robbins.RobbinsPrimalDualOCP import RobbinsPrimalDual
import numpy as np
...
def main_primal_dual():
    ...
    while not convergence:
        ...
        if not infos.success:
            raise Exception("Primal dual robbins problem failed before convergence")
    ...
    with open("Robbins/results_robbins_primal_dual.pickle", "wb") as fh:
