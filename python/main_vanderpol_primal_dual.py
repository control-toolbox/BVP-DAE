...
"""
from VanDerPol.VanDerPolPrimalDualOCP import VanDerPolPrimalDualOCP
...
def main_primal_dual():
    ...
    while not convergence:
        ...
        if not infos.success:
            raise Exception("Primal-dual Van der Pol problem failed before convergence")
    ...
    with open("VanDerPol/results_vanderpol_primal_dual.pickle", "wb") as fh:
